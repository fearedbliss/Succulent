...
| **Rings To Amulet** | 3x Rings | Creates one magic amulet. |
| **Amulets To Ring** | 3x Amulets | Creates one magic ring. |
...
| **Upgrade Gem** | 3x Same Type of Gem | Next Higher Quality Gem (Up to Perfect). |

### Gear Modification

| Name | Components | Result |
| --- | --- | --- |
| **Add Sockets To Item** | Socketable Item (With No Sockets) + 4 Perfect Gems | Adds the **maximum** amount of sockets allowed on that item. |
...
| **Hitpower Amulet** | Amulet + Jewel + Tal Rune + Perfect Sapphire | Hit Causes Monster To Flee (5-15)%. 5% Chance To Cast Level 4 Frost Nova When Struck. Attacker Takes Damage of (3-10). |
| **Hitpower Ring** | Ring + Jewel + Ral Rune + Perfect Sapphire | +(1-5) To Dexterity. 5% Chance To Cast Level 4 Frost Nova When Struck. Attacker Takes Damage of (3-6).  |
...
| **Blood Amulet** | Amulet + Jewel + Tal Rune + Perfect Ruby | (5-10)% Faster Run/Walk. (1-4)% Life Stolen Per Hit. +(10-20) To Life. |
| **Blood Ring** | Ring + Jewel + Ral Rune + Perfect Ruby | +(1-5) To Strength. (1-3)% Life Stolen Per Hit. +(10-20) To Life. |
...
| **Caster Amulet** | Amulet + Jewel + Tal Rune + Perfect Amethyst | (5-10)% Faster Cast Rate. (4-10)% Regenerate Mana. +(10-20) To Mana. |
| **Caster Ring** | Ring + Jewel + Ral Rune + Perfect Amethyst | +(1-5) To Energy. (4-10)% Regenerate Mana. +(10-20) To Mana. |
...
| **Safety Amulet** | Amulet + Jewel + Tal Rune + Perfect Emerald | +(1-10)% Increased Chance Of Blocking. Magic Damage Reduced By (1-2). Damage Reduced By (1-4). |
| **Safety Ring** | Ring + Jewel + Ral Rune + Perfect Emerald | +(1-5) To Vitality. Magic Damage Reduced By (1-2). Damage Reduced By (1-4). |
